...
public class JpaWatcherRepository implements WatcherRepository {
    private final WatcherJpaRepository jpaRepository;
    private final WatchJpaRepository watchJpaRepository;

    public JpaWatcherRepository(WatcherJpaRepository jpaRepository, WatchJpaRepository watchJpaRepository) {
